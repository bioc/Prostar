...
As an example, please find the file "MinProt.txt" at this address \url{http://www.bioconductor.org/packages/release/bioc/vignettes/DAPAR/inst/doc/MinProt.txt}.
...
\Biocpkg{Prostar} and ready to use.
